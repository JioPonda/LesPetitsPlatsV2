...
function searchAlgo() {
  ...
  getRecipes().then((data) => {
    ...
    const filteredRecipes = recipesList.filter((recipe) => {
      // Recherche du terme dans le nom de la recette, le nom de l'ingrédient
    ...
    // Créeation de nouvelles cartes pour chaque recette filtrée
...
function displayUstensiles(ustensilsList) {
  ...
  // Obtention de la liste des ustensiles présents dans les recettes filtrées
